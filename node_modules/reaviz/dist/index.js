...
import { Fragment, createRef, useState, useCallback, useEffect, useMemo, Component, Children, cloneElement, useRef, createContext, useContext, forwardRef, useImperativeHandle, createElement, isValidElement } from "react";
...
const LinearAxisLine = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    strokeGradient && /* @__PURE__ */ jsx(CloneElement, { element: strokeGradient, id: `axis-gradient-${id}` })
  ] });
};
...
const LinearAxis = (props) => {
  ...
  return /* @__PURE__ */ jsxs("g", { transform: `translate(${translateX}, ${translateY})`, ref: containerRef, children: [
...
const LinearAxisTickLabel = ({
  ...
  return /* @__PURE__ */ jsxs("g", { transform: `translate(${x}, ${y})`, fontSize, fontFamily, children: [
...
LinearAxisTickSeries.defaultProps = {
  line: /* @__PURE__ */ jsx(LinearAxisTickLine, { height: 10, width: 10, orientation: "horizontal", position: "center" }),
  label: /* @__PURE__ */ jsx(LinearAxisTickLabel, { line: /* @__PURE__ */ jsx(LinearAxisTickLine, { orientation: "horizontal", position: "center", height: 5, width: 5 }), text: "", fullText: "", angle: 0, orientation: "horizontal", half: "start", position: "center" }),
  tickSize: 30
};
...
const getClosestPoint = (pos, scale2, data, attr = "x", round = false) => {
  if (scale2.invert) {
    ...
    if (scale2.mariemkoInvert) {
      ...
      prop = scaleBandInvert(scale2, round)(pos);
    }
  ...
  return /* @__PURE__ */ jsx(
    Move,
    {
      ...
      children: /* @__PURE__ */ jsxs("g", { children: [
        /* @__PURE__ */ jsx("line", { className: css$r.line, y1: "0", y2: height, x1: "5", x2: "5" }),
        /* @__PURE__ */ jsx(
          "rect",
          {
        ...
        /* @__PURE__ */ jsx(
          "g",
          {
            ...
            style: { pointerEvents: "none" },
            children: range(5).map((i) => /* @__PURE__ */ jsx("circle", { cy: i * 5, cx: "5", r: ".5", className: css$r.dot }, i))
          }
        )
      ] })
    }
...
const BrushSlice = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("rect", { className: css$q.unsliced, height, width: start2 }),
    /* @__PURE__ */ jsx(
      "rect",
      {
...
const DiscreteLegendEntry = ({
  ...
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("span", { className: css$m.label, children: label2 })
    ]
  }
);
...
const SequentialLegend = ({ className, style, data, colorScheme = ["rgba(28, 107, 86, 0.5)", "#2da283"], orientation = "orientation" }) => {
  ...
  const [end2, start2] = useMemo(() => extent$1(
    uniqueBy(
      data,
      (d) => d.data,
      (d) => d.data
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: css$l.start, children: formatValue(start2) }),
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: css$l.end, children: formatValue(end2) })
      ]
    }
  );
};
...
const GridStripe = ({
  ...
  return /* @__PURE__ */ jsx("rect", { className: classNames(css$j.gridStripe, className), ...coords });
};
...
const GradientStop = ({
  ...
  offset,
  stopOpacity = 1
}) => /* @__PURE__ */ jsx("stop", { offset, stopOpacity, stopColor: color });
const Gradient = ({
  id,
  color,
  direction,
...
const TooltipTemplate = ({
  ...
  const renderValues = (data, index) => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: css$h.subValue, children: [
      /* @__PURE__ */ jsx("span", { className: css$h.subValueColor, style: { backgroundColor: fill } }),
      /* @__PURE__ */ jsxs("span", { className: css$h.subValueName, children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className, role: "tooltip", children: [
    /* @__PURE__ */ jsx("div", { className: css$h.label, children: formatValue(value2.x) }),
    /* @__PURE__ */ jsxs("div", { className: css$h.value, children: [
...
const MotionPath = ({ custom, transition, ...rest }) => {
  ...
  useEffect(() => {
    let interpolator = interpolate$1(d.get(), custom.enter.d);
    spring.set(1);
...
const Glow = () => /* @__PURE__ */ jsx(Fragment, {});
Glow.defaultProps = {
  x: 1,
  y: 1,
  blur: 5,
  ...
  const renderPoint = useCallback(
    (pointData, index) => {
      ...
      if (visible && !visible(pointData, index)) {
        return /* @__PURE__ */ jsx(Fragment, {}, key);
      }
      return /* @__PURE__ */ jsx(
        CloneElement,
        {
...
const AreaSeries = ({
  ...
  const renderMarkLine = useCallback(() => /* @__PURE__ */ jsx(Fragment$1, { children: activeValues && markLine2 && /* @__PURE__ */ jsx(
    CloneElement,
    {
      element: markLine2,
      height,
...
const useInterpolate$1 = ({ data, animated, arc: arc2 }) => {
  ...
  useEffect(() => {
    ...
    const unsub = spring.onChange((v) => d.set(arc2(interpolator(v))));
    prevPath.set(data);
    return unsub;
  }, [arc2, d, data, prevPath, previousEnter, spring]);
  return {
    d,
    transition
  };
...
const PieArc = ({
  ...
  const { transition, d } = useInterpolate$1({ animated, arc: arc2, data });
  const [active, setActive] = useState(false);
  const fill = useMemo(
  ...
  return /* @__PURE__ */ jsxs("g", { ref: arcRef, children: [
    /* @__PURE__ */ jsx(
      motion.path,
      {
...
const PieChart = ({
  ...
  const renderSeries = useCallback(({ chartWidth, chartHeight }) => {
    return /* @__PURE__ */ jsx(
      CloneElement,
      {
        element: series,
...
const SankeyNode = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(motion.g, { ref: rectRef, children: /* @__PURE__ */ jsx(
      motion.rect,
      {
...
const RadialScatterPlot = ({
  ...
  const getScales = useCallback(
    (aggregatedData, outer, inner) => {
      ...
      const xScale = scaleTime().range([0, 2 * Math.PI]).domain(xDomain);
...
const RadialScatterSeries = ({
  ...
  const onMouseEnter = useCallback(({ value: value2 }) => {
    if (!activeIds) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: data.map(renderPoint) });
};
...
const RadialBarSeries = ({
  ...
  return /* @__PURE__ */ jsx(
    CloneElement,
    {
      ...
      startAngle,
      endAngle,
      children: isMultiSeries ? data.map((groupData, index) => /* @__PURE__ */ jsx("g", { children: renderBarGroup(
        groupData.data,
        data.length,
...
const RadialGauge = ({
  ...
  const newId = useId(id);
  const renderSeries = useCallback(({ chartHeight, chartWidth }) => {
    let scale2;
...
const HeatmapCell = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("g", { ref: rect, children: /* @__PURE__ */ jsx(
      motion.rect,
      {
        ...rest,
        fill,
...
const VennSeries = ({
  ...
  const renderArc = useCallback(
    (d, index) => {
      ...
      const stroke = typeof arc2.props.stroke === "function" ? (
        // @ts-ignore
        arc2.props.stroke(data, index, isActive, isHovered)
      ) : arc2.props.stroke;
  ...
  return /* @__PURE__ */ jsx(Fragment$1, { children: data.map((d, i) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("label", { className: classNames(css$1.label, labelClassName), children: label2 }),
          renderBar(d, i),
          /* @__PURE__ */ jsx(
            "label",
            {
...
const FunnelArc = ({
  ...
  return /* @__PURE__ */ jsx(
    CloneElement,
    {
      ...
      children: /* @__PURE__ */ jsxs("g", { pointerEvents: tooltip2 ? "none" : "auto", children: [
        /* @__PURE__ */ jsx(
          motion.path,
          {
