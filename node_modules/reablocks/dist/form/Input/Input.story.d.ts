...
declare const _default: {
    title: string;
    component: React.ForwardRefExoticComponent<import("./Input").InputProps & React.RefAttributes<import("./Input").InputRef>>;
};
...
export declare const StartEndAdorment: () => import("react/jsx-runtime").JSX.Element;
