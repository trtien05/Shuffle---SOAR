...
const LoginDialog = (props) => {
  ...
  //Nếu đã login thì chuyển hướng sang trang workflows
  if (isLoggedIn === true) {
    navigate("/workflows");
  }
  ...
  const checkAdmin = () => {
    ...
    fetch(url, {
      ...
      .catch((error) => {
        if (!loginViewLoading) {
          //thay đổi true thành false để thấy form LOGIN
          setLoginViewLoading(false);
          start();
        }
      });
  ...
  // Check for changes in admin status
  ...
  //Kiểm tra xem phải request lần đầu không
  if (firstRequest) {
        ...
        .then((response) =>
          response.json().then((responseJson) => {
            ...
            if (responseJson["success"] === false) {
              ...
              const tmpView = new URLSearchParams(
          ...
          <div style={{ textAlign: "center", marginTop: 50 }}>
            ...
            >
              ...
              <Typography
                ...
                style={{ marginBottom: 20, color: "white" }}
              >
                <b>1.</b> Make sure shuffle-database folder has
                correct access, and that you have a minimum of{" "}
