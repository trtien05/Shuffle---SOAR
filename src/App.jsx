...
const App = (message, props) => {
  ...
  const includedData = (
    ...
    >
      ...
      <Routes>
        ...
        />
        {/* Route settings for Settings Page */}
        ...
        {/* Route AdminSetup for Admin Setup */}
        <Route
          exact
          path="/AdminSetup"
          element={
        ...
        />
        {/* Route detectionframework for Detection framework */}
        <Route
          exact
  ...
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <CookiesProvider>
        <BrowserRouter>{includedData}</BrowserRouter>
        <ToastContainer
